...
<section class="landing-hero" id="inicio">
    <div class="container landing-hero-inner">
        <span class="landing-badge">Plataforma SaaS institucional</span>
        <h1>SIGERD: clareza para decidir, coordenar e responder com seguranca.</h1>
        <p>
...
<section class="container landing-section" id="solucao">
    <header class="landing-section-header">
        <span>Solucao</span>
        <h2>Um sistema unico para risco, resposta e governanca</h2>
    </header>
